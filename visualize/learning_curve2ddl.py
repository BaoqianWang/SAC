...
with open('/home/smile/sac/result/wmc/darl1n/9agents_2000_ddl2/good_agent.pkl','rb') as f:
    reward_darl1n = pickle.load(f)


# DARL1N 2 agents coded
with open('/home/smile/sac/result/wmc/sac/9_agents/2_ddl/correct_reward.pkl','rb') as f:
    reward_sac = pickle.load(f)



plt.figure(figsize=(5.8,4.5))
plt.plot(reward_sac, linestyle=':', linewidth=line_width, label='SAC')
plt.plot(reward_darl1n, linestyle=':', linewidth=line_width, label='DARL1N')

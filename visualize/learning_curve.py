...
with open('/home/smile/sac/result/wmc/darl1n/9agents/good_agent.pkl','rb') as f:
...
reward_darl1n = [50, 71, 57, 58, 65, 77, 75, 71, 72, 74, 73, 79, 77, 72, 72, 73, 77, 77, 74, 76, 72, 76, 71, 74, 75, 72, 76]
...
plt.grid()
plt.savefig('../figures/sac', transparent = False)
plt.show()
...
plt.subplots_adjust(bottom=0.15, left=0.2, top=0.95, wspace=0, hspace=0)
plt.grid()
plt.savefig('../figures/darl1n', transparent = False)
plt.show()

...
from experiments.helper.distributions import make_pdtype
from experiments.helper.replay_buffer_neighbor import ReplayBuffer
...
class MADDPGAgentTrainer():
    def __init__(self, name, model, obs_shape_n, session, act_space_n, agent_index, args, local_q_func=False):
        ...
        self.max_neighbors = args.max_num_neighbors

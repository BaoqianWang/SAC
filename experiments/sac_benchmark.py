...
if __name__ == "__main__":
    ...
    np.random.seed()
    k = 1
    policyRewardSmooth = networkRLModel.train(k = k, M = M, evalInterval = evalInterval,restartIntervalQ = restartIntervalQ, restartIntervalPolicy = restartIntervalPolicy, clearPolicy = True)
    plt.rc('font', size=14)
